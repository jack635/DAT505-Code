...
function setupWorld() {
  ...
  var material = new THREE.MeshPhongMaterial({overdraw: true, color: 0x000000,wireframe:true});
  ...
  for (var i = 0; i < 1000; i++) {
    ...
    building.scale.x  = 10;//Math.pow(Math.random(), 2) * 50 + 10;
    building.scale.y  =10; //Math.pow(Math.random(), 3) * building.scale.x * 8 + 8;
    building.scale.z  = 10;//building.scale.x;
